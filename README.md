...
|------------------------------|----------------------------------|------------------------|---------------|
| **EC2 (Auto Scaling Group)** | 2 instances t2.micro en EC2 Instance Savings Plan (1an)   | ~13,43 USD             | Famille d'instance stable. 1 seule région. Moins cher qu'un Compute Savings Plan.
