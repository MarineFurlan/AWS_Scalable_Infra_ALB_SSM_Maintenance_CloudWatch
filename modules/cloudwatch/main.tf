...
resource "aws_cloudwatch_metric_alarm" "alb_4xx_alarm" {
  ...
  metric_name         = "HTTPCode_Target_4XX_Count"                // Mesures 4xx errors generated by instances. Here, the ALB is not the element generating 4xx errors, so the "HTTPCOde_ELB_4XX_Count" metric is irrelevant.
